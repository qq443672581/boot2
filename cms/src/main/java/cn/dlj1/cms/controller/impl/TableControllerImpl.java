 ...
 * @param <T>
 */
public abstract class TableControllerImpl<K extends Key, T extends Entity>
        extends ControllerImpl<K, T> implements TableController<K, T> {

    private static Log log = LogFactory.getLog(TableControllerImpl.class);
